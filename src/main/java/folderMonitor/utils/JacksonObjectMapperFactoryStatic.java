 ...
 * 
 */
public class JacksonObjectMapperFactoryStatic {

	/*
	 * Don't change the default behaviour of this class. Bugs will be introduced if the defaults changes.  
	 */
	private static boolean failOnEmptyBeans = false;
	private static boolean indentOutput = true;
	private static boolean serializeNullsAsEmptyStrings = true;
	public static String dateTimeFormat = "yyyy-MM-dd HH:mm:ss";
	private static boolean outputNulls = false;
	private static boolean singleton = true;
	
	public static ObjectMapper getObject() throws Exception {
	...
	private static void configureOutputNulls(ObjectMapper result) {
		if(!isOutputNulls()){
			result.setSerializationInclusion(Include.NON_NULL);
		}
	}

	private static void configureDateTimeFormat(ObjectMapper result) {
	 ...
	 * @param result
	 */
	private static void configureVisibility(ObjectMapper result) {
	...
	public static boolean isFailOnEmptyBeans() {
	...
	public static boolean isIndentOutput() {
		return indentOutput;
	}
	...
	public static boolean isOutputNulls() {
		return outputNulls;
	}
